...
The median is 167.6 cm: this means that _about_ 50% of the customers were shorter than
167.6 cm.

1st Qu.: 1st quartile (quarter, four parts): about 25% of the customers were shorter than 162.6 cm. About 75% of the customers were taller than 162.6 cm.

3rd Qu.: 3rd quartile (quarter, four parts): about 75% of the customers were shorter than 175.9 cm. About 25% of the customers were taller than 175.9 cm.


Compute the share of customers who were shorter than the 1st quartile.


```{r}
earnings <- earnings %>%
  mutate(
    is_less_than_1q = height_cm < 162.6  
  )

## Number of observations that meet the condition: height_cm < 162.6

sum(earnings$is_less_than_1q)
```
...
earnings1 <- earnings %>%
  ...
  select(male, male1, gender, ethnicity)
```

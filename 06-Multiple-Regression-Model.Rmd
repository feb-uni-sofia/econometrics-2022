...
$$
\hat{C}_{HS = 80, U = 50} = 59.1 - 0.5834 \cdot 80 + 0.68 U = 12.4 + 0.68 \cdot 50\\
\hat{C}_{HS = 50, U = 50} = 59.1 - 0.5834 \cdot 50 + 0.68 U = 29.93+ 0.68 \cdot 50 \\
\hat{C}_{HS = 80, U = 50} - \hat{C}_{HS = 50, U = 50} = 12.4 - 29.93 = -16.9
$$
...
$$
C_i = \beta_0 + \beta_1 (\text{HS}_i - \overline{HS})   + \beta_2 \text{U}_i + e_i
$$
...
```{r}
## I: identity function
fit_HS_centered <- lm(C ~ 1 + I(HS - mean(HS)), data = crime)
fit_HS_centered
```

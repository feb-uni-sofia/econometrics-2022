...
$$
\underbrace{C_i}_{\text{Crime}} = \beta_0 + \beta_1 \underbrace{\text{HS}_i}_{\text{Share of persons with high school degree}} + u_i, \quad i = 1,\ldots,n = 67
$$
...
$$
\hat{C}_{HS = 80}  = -50.8 + 1.48 \times 80 = 67.6\\
\hat{C}_{HS = 50}  = -50.8 + 1.48 \times 50 = 23.2\\
$$
...
$$
C_i = \beta_0 + \beta_1 \text{HS}_i  + \beta_2 \text{U}_i + u_i
$$
